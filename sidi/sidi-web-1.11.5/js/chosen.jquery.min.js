    ...
    function() {
        ...
        n = this, e = jQuery, e.fn.extend({
            ...
            return i(r, t), r.prototype.setup = function() {
                ...
                var t, n, r, i;
                if (this.result_highlight) return t = this.result_highlight, t.hasClass("create-option") ? (this.select_create_option(this.search_field.val()), this.results_hide()) : (n = t.attr("id"), this.result_clear_highlight(), this.is_multiple ? this.result_deactivate(t) : (this.search_results.find(".result-selected").removeClass("result-selected"), this.result_single_selected = t, this.selected_item.removeClass("chzn-default")), t.addClass("result-selected"), i = n.substr(n.lastIndexOf("_") + 1), r = this.results_data[i], r.selected = !0, this.form_field.options[r.options_index].selected = !0, this.is_multiple ? this.choice_build(r) : (this.selected_item.find("span").first().text(r.text), this.allow_single_deselect && this.single_deselect_control_build()), (!e.metaKey && !e.ctrlKey || !this.is_multiple) && this.results_hide(), this.search_field.val(""), (this.is_multiple || this.form_field.selectedIndex !== this.current_selectedIndex) && this.form_field_jq.trigger("change", {
                ...
                if (this.create_option && (c < 1 || !n && this.persistent_create_option) && h.length) return this.show_create_option(h)
                ...
                var n;
                return n = e('<li class="create-option active-result"><a href="javascript:void(0);">' + this.create_option_text + '</a>: "' + t + '"</li>'), this.search_results.append(n)
